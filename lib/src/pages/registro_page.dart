      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        return Container(
          ...
          child: TextField(
            ...
            onChanged: (value) => bloc.changePasssword(value),
          ),
        );
      },
    );
  ...
  Widget _crearFondo(context) {
    ...
    final fondoColor = Container(
      ...
      decoration: BoxDecoration(
        ...
        Color.fromRGBO(0, 2, 36, 0.9),
        //Color.fromRGBO(33, 9, 121, 1.0),
        Color.fromRGBO(0, 134, 255, 1.0),
      ])),
    );
    ...
    return Stack(
      children: [
        ...
        Positioned(top: 290.0, left: -40.0, child: circulo),
        Container(
          height: 300.0,
          width: 500.0,
